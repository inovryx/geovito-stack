...
SCRIPT_IN_CONTAINER="scripts/blog_comment_state_contract_check.js"
...
echo "=============================================================="
echo "GEOVITO BLOG COMMENT STATE CONTRACT CHECK"
echo "=============================================================="
...
docker compose exec -T strapi node scripts/blog_comment_state_contract_check.js
