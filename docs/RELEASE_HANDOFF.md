...
## Release Snapshot
- Latest strict full-gate PASS evidence: `artifacts/go-live/go-live-full-20260318T190638Z.txt`
- Latest strict full-gate run id: `gv-run-20260318T190638Z-25006`
- Latest strict full-pass checkpoint tag: `checkpoint-go-live-full-pass-20260318-1915`
- Latest checkpoint tag (post-pass docs sync): `checkpoint-go-live-full-pass-20260318-1915`
- Latest readiness state: `ready=true` (`error_samples=43`, `storage_samples=43`, `error_distinct_days=7`, `storage_distinct_days=7`)
...
- Latest pushed commit at handoff creation: `f56fd3a`
